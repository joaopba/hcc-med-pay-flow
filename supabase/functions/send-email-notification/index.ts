        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center;">
              ...
              <p style="margin: 10px 0 0 0; color: #ffffff; font-size: 18px; font-weight: 400;">Nova Nota Fiscal Recebida</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f8f9fa; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                <tr>
                  <td>
                    <h2 style="margin: 0 0 20px 0; color: #333; font-size: 20px; font-weight: 600; border-left: 4px solid #667eea; padding-left: 12px;">
                      📋 Detalhes da Nota
                    </h2>
                    <table width="100%" cellpadding="8" cellspacing="0" border="0">
                      <tr>
                        <td style="color: #666; font-size: 14px;">
                          <strong style="color: #333;">Médico:</strong>
                        </td>
                        <td style="color: #333; font-size: 14px; text-align: right;">
                          ${(pagamento.medicos as any)?.nome}
                        </td>
                      </tr>
                      <tr>
                        <td style="color: #666; font-size: 14px;">
                          <strong style="color: #333;">Especialidade:</strong>
                        </td>
                        <td style="color: #333; font-size: 14px; text-align: right;">
                          ${(pagamento.medicos as any)?.especialidade || 'Não informado'}
                        </td>
                      </tr>
                      <tr>
                        <td style="color: #666; font-size: 14px;">
                          <strong style="color: #333;">Competência:</strong>
                        </td>
                        <td style="color: #333; font-size: 14px; text-align: right;">
                      ...
                      <tr>
                        <td style="color: #666; font-size: 14px;">
                          <strong style="color: #333;">Arquivo:</strong>
                        </td>
                        <td style="color: #333; font-size: 14px; text-align: right;">
                          ${fileName || 'nota.pdf'}
                        </td>
              ...
              <p style="text-align: center; color: #333; font-size: 16px; margin: 0 0 30px 0; line-height: 1.5;">
                A nota fiscal foi recebida e está aguardando sua análise.<br>
                Clique nos botões abaixo para aprovar ou rejeitar:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td align="center" style="padding: 10px;">
                    <a href="${pdfDownloadUrl}" style="display: inline-block; background-color: #667eea; color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 2px 4px rgba(102,126,234,0.3);">
                      📎 Baixar PDF da Nota
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding: 10px;">
                    <a href="${approveUrl}" style="display: inline-block; background-color: #10b981; color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 2px 4px rgba(16,185,129,0.3);">
                      ✅ Aprovar Nota
                    </a>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding: 10px;">
                    <a href="${rejectUrl}" style="display: inline-block; background-color: #ef4444; color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 2px 4px rgba(239,68,68,0.3);">
                      ❌ Rejeitar Nota
                    </a>
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding: 20px 10px 10px 10px;">
                    <a href="https://hcc.chatconquista.com" style="display: inline-block; background-color: #667eea; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 500; font-size: 14px;">
              ...
              <p style="text-align: center; color: #666; font-size: 12px; margin: 20px 0 0 0;">
                💡 O PDF também está anexado neste email. Link válido por 7 dias.
              </p>
              ` : ''}
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 20px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; color: #666; font-size: 12px; line-height: 1.5;">
                Sistema de Gestão de Pagamentos - HCC Hospital<br>
